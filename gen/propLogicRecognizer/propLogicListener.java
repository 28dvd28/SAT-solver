...
public interface propLogicListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link propLogicParser#main}.
	 * @param ctx the parse tree
	 */
	void enterMain(propLogicParser.MainContext ctx);
	/**
	 * Exit a parse tree produced by {@link propLogicParser#main}.
	 * @param ctx the parse tree
	 */
	void exitMain(propLogicParser.MainContext ctx);
	/**
